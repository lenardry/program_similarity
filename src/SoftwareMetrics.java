...
public class SoftwareMetrics
{
    ...
    public static ArrayList<Double> displayMetrics(int N1,int N2,int n1,int n2)
    {
        int N,n;
        float V,D,L,E,T,B;
        ...
        metrics.add((double) N);
        metrics.add((double) n);
        metrics.add((double) V);
        metrics.add((double) D);
        metrics.add((double) L);
        metrics.add((double) E);
        metrics.add((double) T);
        metrics.add((double) B);
    ...
    public ArrayList<Double> getMetrics(String path) throws IOException {
    ...
    {
        SoftwareMetrics h = new SoftwareMetrics();
    }
}